...
public class Scene21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                playSound(1);
                Intent aha =new Intent(getApplicationContext(),Scene22.class);
                startActivity(aha);
                finish();
            }
        });
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                playSound(1);
                AlertDialog.Builder builder = new AlertDialog.Builder(Scene21.this);
